...
def login(username, password):
    ...
    if showpin == 0:
        ...
        # r1 = session.get("http://weibo.com/u/5661932459/home",headers=headers)
        # r1.encoding = "GBK"
        # print(r1.text)
    else:
    ...
    # print(uuid_res)
    '''"http://weibo.com/%s/profile?topnav=1&wvr=6&is_all=1"'''
    ...
    print(attention_count,fans_count,)
...
def like(session):
    select_url = "http://s.weibo.com/weibo/{0}&Refer=focus_lx_STopic_box"
